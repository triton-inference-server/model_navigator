...
By default, we're using the 22.03 container version that contains:

- PyTorch 1.12.0a0+2c916ef
- TensorFlow 2.8.0 / 1.15.5
- TensorRT TensorRT 8.2.3
- [Triton Inference Server 2.20.0](https://github.com/triton-inference-server/server/releases/tag/v2.20.0)
