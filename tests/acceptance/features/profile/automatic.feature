Feature: Model Automatic Profiling
    ...
    Scenario: User uses Model Analyzer Automatic Configuration Search on cpu only instances
        ...
        And the my_model model configs in latest profile checkpoint are
            ...
            {"maxBatchSize": 4, "instanceGroup": [{"count": 1, "kind": "KIND_CPU"}], "dynamicBatching": {}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 2, "kind": "KIND_CPU"}], "dynamicBatching": {}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 1, "kind": "KIND_CPU"}], "dynamicBatching": {"preferredBatchSize": [1]}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 2, "kind": "KIND_CPU"}], "dynamicBatching": {"preferredBatchSize": [1]}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 1, "kind": "KIND_CPU"}], "dynamicBatching": {"preferredBatchSize": [2]}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 2, "kind": "KIND_CPU"}], "dynamicBatching": {"preferredBatchSize": [2]}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 1, "kind": "KIND_CPU"}], "dynamicBatching": {"preferredBatchSize": [4]}, "cpu_only": true}
            {"maxBatchSize": 4, "instanceGroup": [{"count": 2, "kind": "KIND_CPU"}], "dynamicBatching": {"preferredBatchSize": [4]}, "cpu_only": true}
        And the my_model model was profiled with 1 2 4 concurrency levels
