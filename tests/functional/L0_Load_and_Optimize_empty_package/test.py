...
"""e2e tests for exporting empty package"""
...
def main():
    ...
    from model_navigator.configuration import DEFAULT_ONNX_TARGET_FORMATS
    ...
    package_path = get_assets_path() / "packages" / "empty.nav"
