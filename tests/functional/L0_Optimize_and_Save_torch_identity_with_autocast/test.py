...
from model_navigator import TorchConfig, TorchExportConfig, TorchScriptConfig
...
def main():
    ...
    package = nav.torch.optimize(
        ...
        custom_configs=[TorchConfig(autocast=True), TorchScriptConfig(autocast=True), TorchExportConfig(autocast=True)],
    )
