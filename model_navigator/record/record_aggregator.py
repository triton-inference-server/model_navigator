...
class RecordAggregator:
    ...
    def insert(self, record):
        ...
        if isinstance(record, record.Record):
    ...
    def add_key(self, record_type, records):
        ...
        try:
            ...
            raise RecordAggregatorKeyError(record_type=record_type)
        ...
        for record_type in record_types:
            ...
            for field_value in field_values[record_type]:
                aggregated_result = self.filter_records(
                    record_types=[record_type], filters=[lambda r: groupby_criterion(r) == field_value]
                ).aggregate(record_types=[record_type])
                groupby_result[record_type][field_value] = aggregated_result[record_type]
    ...
    def aggregate(self, record_types=None):
        ...
        aggregated_records = {
            record_type: record_type.aggregation_function()(self._records[record_type]) for record_type in record_types
        }
