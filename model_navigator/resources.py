...
from .core import Accelerator, Format
...
FORMAT2RESOURCE = {
    Format.TF_GRAPHDEF: Resource.TENSORFLOW,
    Format.TF_CHECKPOINT: Resource.TENSORFLOW,
    Format.TF_SAVEDMODEL: Resource.TENSORFLOW,
    Format.TF_TRT: Resource.TENSORFLOW,
    Format.TF_ESTIMATOR: Resource.TENSORFLOW,
    Format.TF_KERAS: Resource.TENSORFLOW,
    Format.ONNX: Resource.ONNX,
    Format.TRT: Resource.TENSORRT,
    Format.TS_SCRIPT: Resource.PYTORCH,
    Format.TS_TRACE: Resource.PYTORCH,
    Format.PYT: Resource.PYTORCH,
}

ACCELERATOR2RESOURCE = {
    Accelerator.TRT: Resource.TENSORRT,
    Accelerator.AMP: Resource.AMP_ACCELERATOR,
}
