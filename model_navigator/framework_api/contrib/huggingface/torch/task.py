...
TASK_MODELS_MAPPING = OrderedDict(
    [
        (Task.SEQUENCE_CLASSIFICATION, set(MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES.values())),
        (Task.QUESTION_ANSWERING, set(MODEL_FOR_QUESTION_ANSWERING_MAPPING_NAMES.values())),
        (Task.CAUSAL_LM, set(MODEL_FOR_CAUSAL_LM_MAPPING_NAMES.values())),
        (Task.MASKED_LM, set(MODEL_FOR_MASKED_LM_MAPPING_NAMES.values())),
        (Task.BASE, set(MODEL_MAPPING_NAMES.values())),
    ]
)
