...
def get_pretrained_model_from_config(config: PretrainedConfig, torchscript: bool = False) -> PreTrainedModel:
    ...
    return model_cls.from_pretrained(config.name_or_path, torchscript=torchscript)
