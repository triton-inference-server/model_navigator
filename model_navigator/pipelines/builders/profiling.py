...
def profiling_builder(config: CommonConfig, models_config: Dict[Format, List[ModelConfig]]) -> Pipeline:
    ...
    return Pipeline(name=PIPELINE_PROFILING, execution_units=execution_units)
