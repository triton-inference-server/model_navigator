    ...
    def set_value(self, value):
        ...
        try:
            ...
            if self._is_list(value):
                ...
                two_key_condition = len(value) == 2 and "start" in value and "stop" in value
                three_key_condition = len(value) == 3 and "start" in value and "stop" in value and "step" in value
