...
from ..constants import CONFIG_PARSER_FAILURE
...
class ConfigField:
    ...
    def set_required(self, required):
        self._field_type.set_required(required)

    def set_name(self, name):
        self._field_type.set_name(name)

    def __eq__(self, o: "ConfigField") -> bool:
        return (
            self._description == o._description
            and self._default_value == o._default_value
            and self._name == o._name
            and self._field_type == o._field_type
            and self._flags == o._flags
            and self._choices == o._choices
            and self._parser_args == o._parser_args
        )
