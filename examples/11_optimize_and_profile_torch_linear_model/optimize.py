...
def get_profile_dataloader():
    """Returns a random dataloader containing 2 batches of 3x5 tensors"""
    return [torch.randn(3, 5) for _ in range(2)]
...
def main():
    ...
    results = nav.package.profile(package=package, dataloader=get_profile_dataloader())
